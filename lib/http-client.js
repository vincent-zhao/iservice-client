...
Client.prototype.get = function (url, callback, headers, timeout) {
  this._call(this._host(), 'GET', url, null, headers, callback, timeout);
  return this;
}
/* }}} */

/* {{{ Client prototype post() */
Client.prototype.post = function (url, data, callback, headers, timeout) {
  this._call(this._host(), 'POST', url, data, headers, callback, timeout);
  return this;
}
/* }}} */
 ...
 * @access private
 */
Client.prototype._call = function (host, method, url, data, headers, callback, timeout) {
  if (!host) {
  ...
  timeout   = timeout || (_self.options.timeout + 10);
  var timer = null;
